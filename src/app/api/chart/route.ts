...
export async function PATCH(request: NextRequest) {
  ...
  let body: { term?: string; hidden?: boolean; promoted?: boolean; instructions?: string | null };
  ...
  if (Object.keys(patch).length === 0) return NextResponse.json({ error: "give at least one of hidden, promoted, instructions" }, { status: 400 });
  try {
