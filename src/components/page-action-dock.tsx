...
function Icon({ name }: { name: PageActionIcon }) {
  ...
  switch (name) {
    ...
    case "map":
      // Org chart: one box on top, three below.
      return <svg {...p}><rect x="9" y="3" width="6" height="5" rx="1" /><rect x="2" y="16" width="6" height="5" rx="1" /><rect x="9" y="16" width="6" height="5" rx="1" /><rect x="16" y="16" width="6" height="5" rx="1" /><path d="M12 8v4" /><path d="M5 16v-4h14v4" /><path d="M12 12v4" /></svg>;
    case "settings":
